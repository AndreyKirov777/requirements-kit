...
git commit -m "chore: update agent files after kit upgrade"
```
...
- **Project artifacts** (your requirements, user stories, etc.) — untouched.
...
| Dry run | `python requirements/scripts/install-agent-files.py --dry-run` |
